package com.jiuair.base.utils;

import com.jiuair.base.entity.ColumnEntity;
import com.jiuair.base.entity.TableEntity;
...
public class GenUtils {
	...
	public static void main(String[] args) throws IOException {
		File file = new File("/Users/reason/opensource/aoe.zip");
		//file.createNewFile();
		ZipOutputStream zipOutputStream = new ZipOutputStream(new FileOutputStream(file));

		HashMap<String, String> table = new HashMap<>();
		table.put("tableName","o_psg_list");
		table.put("tableComment","旅客离港表");
		HashMap<String, String> col = new HashMap<>();
		col.put("columnName","o_psg_sn");
		col.put("dataType","varchar2");
		col.put("columnComment","旅客序号");
		col.put("extra","");

		HashMap<String, String> col2 = new HashMap<>();
		col2.put("columnName","psg_name");
		col2.put("dataType","varchar2");
		col2.put("columnComment","旅客名字");
		col2.put("extra","");
		...
		GenUtils.generatorCode(table,cols,zipOutputStream);
